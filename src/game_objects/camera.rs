...
use cgmath::{
    num_traits::clamp, Angle, Matrix4, One, Quaternion, Rad, Rotation3, Vector3, VectorSpace, Zero,
};

use super::transform::{TransformID, TransformSystem};
...
impl Camera {
    ...
    pub fn sync_transform(&mut self, system: &mut TransformSystem) {
        ...
        self.smooth_pos = self.smooth_pos.lerp(*view.translation, 0.125);
